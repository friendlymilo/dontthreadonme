...
class SDClipModel(torch.nn.Module, ClipTokenWeightEncoder):
    ...
    def __init__(self, version="openai/clip-vit-large-patch14", device="cpu", max_length=77,
                 freeze=True, layer="last", layer_idx=None, textmodel_json_config=None, dtype=None, model_class=exlr.clip_model.CLIPTextModel,
        ...
        self.transformer = model_class(config, dtype, device, exlr.ops.manual_cast)
