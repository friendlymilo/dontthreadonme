...
function addMultilineWidget(node, name, opts, app) {
	...
	inputEl.className = "exlr-multiline-input";
...
function isSlider(display, app) {
	if (app.ui.settings.getSettingValue("Exlr.DisableSliders")) {
		return "number"
	}
...
export const ExlrWidgets = {
	"INT:seed": seedWidget,
	"INT:noise_seed": seedWidget,
	FLOAT(node, inputName, inputData, app) {
		let widgetType = isSlider(inputData[1]["display"], app);
		let precision = app.ui.settings.getSettingValue("Exlr.FloatRoundingPrecision");
		let disable_rounding = app.ui.settings.getSettingValue("Exlr.DisableFloatRounding")
