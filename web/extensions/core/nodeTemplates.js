...
const id = "Exlr.NodeTemplates";
const file = "exlr.templates.json";

class ManageTemplates extends ExlrDialog {
	constructor() {
		super();
		this.load().then((v) => {
			this.templates = v;
		...
		this.element.classList.add("exlr-manage-templates");
		this.draggedEl = null;
						...
						$el(
							"div",
							{
								...
								style: {
									...
									gap: "5px",
									backgroundColor: "var(--exlr-menu-bg)"
								},
								ondragstart: (e) => {
										...
										$el("input", {
											...
											onchange: (e) => {
												...
												this.saveVisualCue = setTimeout(function () {
													...
													el.style.backgroundColor = 'var(--exlr-input-bg)';
												}, 15);
											},
											onkeypress: (e) => {
												var el = e.target;
