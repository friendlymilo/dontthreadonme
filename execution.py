...
def recursive_execute(server, prompt, outputs, current_item, extra_data, executed, prompt_id, outputs_ui, object_storage):
    ...
    except exlr.model_management.InterruptProcessingException as iex:
...
class PromptExecutor:
    ...
    def handle_execution_error(self, prompt_id, prompt, current_outputs, executed, error, ex):
        ...
        if isinstance(ex, exlr.model_management.InterruptProcessingException):
            mes = {
                "prompt_id": prompt_id,
                "node_id": node_id,
    ...
    def execute(self, prompt, prompt_id, extra_data={}, execute_outputs=[]):
        ...
        with torch.inference_mode():
            ...
            exlr.model_management.cleanup_models()
            ...
            if exlr.model_management.DISABLE_SMART_MEMORY:
