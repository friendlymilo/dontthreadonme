...
def inspect_checkpoint(filename):
    ...
    header = exlr.utils.safetensors_header(path)
    if header:
        ...
        unet_config = exlr.model_detection.detect_unet_config(
        ...
        matching_models = (
            model
            for model in exlr.supported_models.models
        ...
        return {
            ...
            "is_refiner": base_model is exlr.supported_models.SDXLRefiner,
        }
    return {"base_model": "unknown"}
