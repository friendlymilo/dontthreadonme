...
def inject_patched_calculate_weight():
    ...
    if not injected_model_patcher_calculate_weight:
        print(
            "[comfyui-inpaint-nodes] Injecting patched exlr.model_patcher.ModelPatcher.calculate_weight"
        )
...
class LoadFooocusInpaint:
    ...
    def load(self, head: str, patch: str):
        ...
        inpaint_lora = exlr.utils.load_torch_file(patch_file, safe_load=True)
...
class ApplyFooocusInpaint:
    ...
    def patch(
        ...
        lora_keys = exlr.lora.model_lora_keys_unet(model.model, {})
...
class LoadInpaintModel:
    ...
    def load(self, model_name: str):
        ...
        if model_file.endswith(".pt"):
            ...
            sd = exlr.utils.load_torch_file(model_file, safe_load=True)
